...
| [Prisma セットアップ](../prisma-setup/) | `libs/prisma-db` — PrismaService, Middleware, seed |
| [NestJS 共通基盤](../common-infrastructure/) | `common/` — Guards, Interceptors, Decorators, Filters |
| [Angular Core 基盤](../angular-core/) | `core/` — AuthService, app.routes.ts, AppShell |
